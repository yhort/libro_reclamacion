    ...
    <div class="container my-5">
        ...
        <div class="card shadow border-0">
            ...
            <div class="card-body p-4 p-md-5">
                ...
                <form method="POST" action="index.php?c=reclamo&a=guardar">
                    ...
                    <div class="text-center mt-3">
                        <p class="text-muted small mb-2">¿Ya registraste un reclamo?</p>
                        <a href="index.php?c=reclamo&a=consultar_form"
